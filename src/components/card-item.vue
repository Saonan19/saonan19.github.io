<template>
    <div class="card border-0" style="min-width:300px;max-width:300px">
        <img :src="src"/>
        <div class="card-body">
          <div class="mb-3"><a class="card-link text-primary read-more" :href="website" target="_blank">Goto Website</a></div>
